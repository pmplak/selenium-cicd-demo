...
pipeline {
    ...
    stages {
         ...
         * Sprint 24
         *
         * Allow test execution to finish so that:
         *
         * 1. JUnit results are published
         * 2. Custom HTML report is generated
         * 3. Quality Gate can make the final decision
         */
         ...
         *
         * UAT:
         * Test result must be SUCCESS before deployment.
         *
         * PROD:
         * Test result must be SUCCESS before approval/deployment.
         */
            ...
            steps {
                ...
                script {
                    ...
                    if (params.Environment == 'QA') {
                        ...
                        echo "QA Quality Gate Evaluation"
                        ...
                        echo "UAT Quality Gate Evaluation"

                        if (currentBuild.currentResult != 'SUCCESS') {

                            error(
                                "UAT Quality Gate Failed - Deployment is blocked."
                            )
                        ...
                        echo "PROD Quality Gate Evaluation"
